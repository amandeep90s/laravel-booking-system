  ...
  return (
    <header className="relative flex flex-col xl:hidden">
      ...
      <div className="transition-all duration-300">
        <div
          className="fixed -left-full z-40 h-screen w-full bg-black/80 transition-all delay-150 duration-300"
          id="mobile-nav-div-overlay"
        />
        <div
          className="fixed -left-full top-16 z-50 h-screen w-full overflow-y-scroll bg-white transition-all delay-0 duration-300"
          id="mobile-nav-div"
        >
