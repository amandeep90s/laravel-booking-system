...
const Appointment = ({ status }) => {
  ...
  const addGuest = () => {
    setGuestsList([...guestsList, { id: guestsList.length + 1, name: '', mobile: '+91 ', aadhaar: '' }]);
  };
        ...
        <div className="theme-container mx-auto grid w-full grid-cols-7 gap-y-16 lg:grid-cols-12 lg:gap-x-[70px] lg:gap-y-0">
          <div className="col-span-12">
            <div className="border-purple/10 rounded-[10px] border p-4 md:p-[50px]">
              <h1 className="text-main-black pb-6 text-[30px] font-semibold tracking-tight">Send Us Message</h1>
              ...
              <form onSubmit={submit} className="grid grid-cols-6 gap-[30px] md:grid-cols-12">
                ...
                {guestsList.map((guest) => (
                  <React.Fragment key={guest.id}>
                    ...
                    <div className="col-span-3">
                      <InputLabel htmlFor={`guestMobile-${guest.id}`} value={`Mobile ${guest.id}`} required={true} />
                    ...
                    <div className="col-span-3">
                      <button
                        ...
                        className="home-two-btn-bg group mt-6 inline-flex border-[#dc2626] bg-[#dc2626] py-1 text-white focus:outline-none"
                      >
                ...
                <div className="col-span-6 md:col-span-12">
                  <PrimaryButton
                    className="home-two-btn-bg group inline-flex border-[#4A7DFF] bg-[#4A7DFF] py-3"
                    disabled={processing}
                  >
                    <span className="font-inter relative z-10 text-base capitalize text-white transition-all duration-300 group-hover:text-[#4A7DFF]">
                      Confirm Visit
